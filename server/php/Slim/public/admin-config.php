...
// Judges
// $subArray = array();
// $subArray['title'] = 'Judges';
// $subArray['route'] = '/admin/actions/judges';
// $subArray['api'] = '/admin/judges';
// $subArray['icon_class'] = 'fa fa-users';
// $subArray['add'] = [];
// $subArray['add']['url'] = '/admin/judges/add';
// $field = array();
// $field['name'] = 'id';
// $field['label'] = 'ID';
// $field['add'] = false;
...
// $subArray = array();
// $fieldList = array();
// $subArray['title'] = 'Executive Team';
// $subArray['query'] = 'executive_team';
// $subArray['route'] = '/admin/actions/executive_team';
// $subArray['icon_class'] = 'fa fa-users';
// $menus[] = $subArray;
